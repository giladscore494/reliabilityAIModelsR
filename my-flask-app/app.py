# -*- coding: utf-8 -*-
# ===================================================================
# 🚗 Car Reliability Analyzer – Israel (v6.5.0 • FINAL Auth FIX)
# ===================================================================
...
def create_app():
    ...
    def login():
        ...
        # ★★★ התיקון הקריטי: מעביר state=None כדי לדלג על ה-CSRF check ב-Authlib ★★★
        # (זה פותר את המעגל האינסופי)
    ...
    def auth():
        ...
        try:
            ...
            # ★★★ התיקון: אנחנו קוראים את פרטי המשתמש ישירות מ-API כדי לדלג על אימות ID Token ★★★
            ...
            traceback.print_exc()
            # אם נכשל, נשלח ללוגאוט כדי לשבור את המעגל האינסופי
...
if __name__ == '__main__':
    ...
    app.run(debug=True, port=port)    fuel_type = db.Column(db.String(100))
    transmission = db.Column(db.String(100))
    result_json = db.Column(db.Text, nullable=False)
